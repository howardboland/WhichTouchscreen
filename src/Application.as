package  
{
    ...
    public class Application extends Sprite
    {
		...
		public function init( e:Event = null ):void
		{
			...
			viewport = new Viewport3D(640, 360, true, false, true, true );
            ...
            image_background = new Image("resources/core/background.jpg", false, true);
        ...
        {
            buttons.setNextPreviousArrows(bool);
        }
		...
		public function resizeHandler(e:Event=null) : void
		{
			...
			image_background.scaleX = scaleFactor;
			image_background.y = this.stage.stageHeight - image_background.height;
